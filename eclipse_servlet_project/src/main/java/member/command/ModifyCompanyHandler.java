...
public class ModifyCompanyHandler implements CommandHandler {
  ...
  @Override
  public String process(HttpServletRequest request, HttpServletResponse responsep)
      throws Exception {
  ...
  private String processSubmit(HttpServletRequest request, HttpServletResponse response)
    ...
    modifyCompanyRequest
        .setBusinessTypeCode(Integer.parseInt(request.getParameter("businessTypeCode")));
    modifyCompanyRequest
        .setBusinessItemCode(Integer.parseInt(request.getParameter("businessItemCode")));
    ...
    modifyCompanyRequest
        .setEstablishmentDate(LocalDate.parse(request.getParameter("establishmentDate")));
    ...
    System.out.println("companynameController: " + modifyCompanyRequest.getCompanyName());
