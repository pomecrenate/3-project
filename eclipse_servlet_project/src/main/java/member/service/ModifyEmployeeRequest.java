...
public class ModifyEmployeeRequest {
  ...
  public ModifyEmployeeRequest(int employeeCode, int companyCode, int departmentCode,
      int positionCode, String employeeName, String employmentType, String address,
      String phoneNumber, String email, LocalDate hireDate, int birthNumber, int residentNumber,
      String companyId) {
    super();
  ...
  public void validate(Map<String, Boolean> errors) {
    ...
    checkEmptyForInt(errors, departmentCode, "departmentCode");
    checkEmptyForInt(errors, positionCode, "positionCode");
